...
<body>
    ...
    <table class=middle>
        ...
        <?php
            ...
            $sql = "SELECT * FROM nootice_borde ORDER BY nb_no DESC limit $start,10";
    ...
    <?php
        // 페이징 링크 생성
        $sql = "SELECT COUNT(*) AS nb_no FROM nootice_borde";
        $res = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($res);
        $total_posts = $row['nb_no'];
        $total_pages = ceil($total_posts / 10);

        echo "<div class='paging_no'>";
