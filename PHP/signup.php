...
<<<<<<< HEAD
function format_phone($newuser_phone){
  $phone = preg_replace("/[^0-9]/", "", $newuser_phone);
  $length = strlen($phone);
  switch($length){
      case 11 :
